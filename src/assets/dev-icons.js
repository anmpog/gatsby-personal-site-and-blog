...
export const MongoIcon = ({
  height = defaultIconProperties.height,
  width = defaultIconProperties.width,
  color = defaultIconProperties.color,
  title = 'MongoDB Icon',
  ...props
}) => {
  return (
...
export const JavaScriptIcon = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d='M1.408 1.408h125.184v125.185h-125.184z'></path>
      <path
        fill='#323330'
